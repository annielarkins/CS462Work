ruleset sensor_profile {
    ...
    rule pico_ruleset_added {
        ...
        pre {
          ...
          s_name = event:attrs{"s_name"} || "Annie's Sensor"
          threshold_temp = event:attrs{"threshold_temp"} || 75
          sms_num = event:attrs{"sms_num"} || "+14103706090"
    ...
    rule auto_accept {
        ...
        if my_role=="temp_sensor" && their_role=="collection" then noop()
        fired {
      ...
      rule generate_report{
        ...
        event:send({
            ...
            "attrs":{"report_correlation_number": rcn,
                      ...
                      "sensor_id": ent:sensor_profile{"s_name"}
                    }.klog("Sending report from sensor " + ent:sensor_profile{"s_name"})
        })
    }
